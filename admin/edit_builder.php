...
if(isset($_GET['page_id'])){
  ...
  $pcont = mysqli_query($mysqli,"select * from mp_pages where page_id = '$pid'");
...
<html lang="en">
 ...
 <div class="col-lg-12"> 
  <div class="form-group mb-2" >
   <input type="hidden" id="mid" value="<?php echo $pid; ?>">
  </div>
 <button class="btn btn-sm btn-success" id="submitIt">Update</button><br>
 <a href="dashboard" class="btn_d">Back to Dashboard</a>
    ...
    <script type="text/javascript">
      ...
      const LandingPage = {
      html: '<div><?php  echo $cget["page_desc"]; ?></div>',
      css: '<?php echo $cget['css']; ?>',
      components: null,
      style: null,
    };
...
$("#submitIt").click(function() {
  ...
  //console.log(cssdata);
   ...
   $.post("../inc/page/update_builder.php", {"html":htmldata, "css":cssdata,"id":id }, 
    function(data) {
        if(data == "added"){
