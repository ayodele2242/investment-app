                            ...
                            foreach ($myproduct as $pro_info) {
                              ...
                              <tr>
                                ...
                                <!--<td>
                                    ...
                                    if ($pro_info['product_image'] !="" && file_exists('../upload/product/'.$sample_image[0])) {
                                     
                                      ?>
                                      <div class="img img-responsive">
                                        <img src="<?php echo '../upload/product/'.$sample_image[0];?>" class="img img-thumbnail" style="width:150px;">
                                      </div>
                                      <?php
                                    } 
                                    ?>
