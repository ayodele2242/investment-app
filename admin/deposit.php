...
$status = FALSE;
if ( authorize($_SESSION["access"]["SAVINGS"]["DEPOSIT"]["create"]) || 
authorize($_SESSION["access"]["SAVINGS"]["DEPOSIT"]["edit"]) || 
authorize($_SESSION["access"]["SAVINGS"]["DEPOSIT"]["view"]) || 
authorize($_SESSION["access"]["SAVINGS"]["DEPOSIT"]["delete"]) ) {
 $status = TRUE;
}
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h4 class="mt-0 mb-0 text-white" >DEPOSIT</h4>
              </div>
...
<div class="card">
    ...
    <div class="row">
        <div class="col s12 refresh scroll">
         ...
         <form autocomplete="off" id="packagesForm" class="row">
                ...
                <div class="form-group mb-2 col l6 s12">
    ...
    <div class="row">
                ...
                <div class="form-group  mb-2 col l4 s12" >
                  <label>Saver's E-mail Address</label>  
                <input type="text" name="email" id="iemail"  required="required" class="form-control" placeholder="">
                </div>
                ...
                <div align="center">
                  <?php if (authorize($_SESSION["access"]["SAVINGS"]["DEPOSIT"]["create"])) { ?>
               
                 <button class="btn btn-md btn-success finish" id="finish"><i class="fa fa-plus"></i> Save</button>
                <?php } ?>
                </div>
                </div>
...
<script>
 ...
 if(saving_id == "" || amt=="" || date =="" || email == ""){
  ...
  $.ajax({
    url: "../inc/saving/processSaving.php",
    method: "post",
