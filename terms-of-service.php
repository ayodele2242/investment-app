<?php include("front-header.php"); ?>
        ...
        =====================================================
        -->
        <div class="our-features-one" id="features" style="margin-top: 40px;">
          <div class="container">
...
This Privacy and Cookie Notice provides information on how AKAWO COMMUNITY collects and processes your personal data when you visit our website or mobile applications.</p>
</li>
<li><p> <strong>The Data We Collect About You?</strong>
We collect your personal data in order to provide and continually improve our products and services. We may collect, use, store and transfer the following different kinds of personal data about you for marketing and personal data optimization purposes. AKAWO COMMUNITY also uses Google Digital Marketing to propose targeted offers.</p>
</li>
...
<li>  Information on your use of our website and/or mobile applications: We automatically collect and store certain types of information regarding your use of AKAWO COMMUNITY including information about your searches, views, downloads and transactions.</li>
...
<li> <strong>Further Details</strong>
  <p>
If you are looking for more information on how we process your personal data, or you wish to exercise your legal rights in respect of your personal data, please contact hello@akawocommunity.com .</p>
</li>
</ol>
              </div> <!-- /.col- -->
