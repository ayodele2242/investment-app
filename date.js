...
(function (root, factory) {
    ...
    return function (el, options) {
        ...
        if (settings.checkIfNativeDate()) {
            ...
            $display = $("<input type='text' readonly='readonly' class='pikaday__display pikaday__display--native form-control " + settings.classes + "' placeholder='" + settings.placeholder + "' />");
            ...
            // Use Pikaday
            $input = $("<input type='text' class='pikaday__display pikaday__display--pikaday form-control " + settings.classes + "' placeholder='" + settings.placeholder + "' />");
            $container.append($input);
